...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-24 right-4 z-50 flex items-center gap-2 rounded-full bg-[#25D366] p-3.5 text-sm font-bold text-white shadow-2xl transition hover:scale-105 motion-reduce:transition-none sm:right-6 md:bottom-6"
    >
